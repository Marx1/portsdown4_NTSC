...
void *sdr_thread(void *arg)
{
  ...
  //printf("Finding AD9361 Receive Driver\n");
  ...
  //printf("Finding AD9361 DAC/TX output device Driver\n");
  ...
  //printf("Buffer created, entering loop\n");
